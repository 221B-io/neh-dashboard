  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col sm="6" lg="3">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" height="{}" class="progress-xs my-3" variant="success"/>
      ...
      <b-col sm="6" lg="3">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" height="{}" class="progress-xs my-3" variant="info"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" height="{}" class="progress-xs my-3" variant="warning"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" height="{}" class="progress-xs my-3" variant="danger"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
    </b-row>
    ...
    <b-row>
      <b-col sm="6" lg="3">
        <b-card class="text-white bg-primary">
          <div class="h4 m-0">89.9%</div>
          <div>Lorem ipsum...</div>
          <b-progress :value="25" height="{}" class="progress-white progress-xs my-3"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
    ...
    <b-card-group class="mb-4">
      <b-card>
        ...
        <b-progress :value="25" height="{}" class="progress-xs mt-3 mb-0" variant="info"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" height="{}" class="progress-xs mt-3 mb-0" variant="success"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" height="{}" class="progress-xs mt-3 mb-0" variant="warning"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" height="{}" class="progress-xs mt-3 mb-0"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" height="{}" class="progress-xs mt-3 mb-0" variant="danger"/>
      </b-card>
    </b-card-group>
    <b-row>
      <b-col sm="6" md="2">
    ...
    <b-row>
      <b-col sm="6" md="2">
        <b-card class="text-white bg-info">
          ...
          <div class="h4 mb-0">87.500</div>
          <small class="text-muted text-uppercase font-weight-bold">Visitors</small>
          <b-progress :value="25" height="{}" class="progress-white progress-xs mt-3"/>
        </b-card>
      </b-col>
      <b-col sm="6" md="2">
